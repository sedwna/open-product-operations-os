...
test("npm package inspection is isolated and contains promised public files", async (t) => {
  ...
  for (const required of [
    ...
    "src/adapters/controlled-writer-contract.js",
    ...
    "schemas/engineering-evidence-amendment.schema.json",
    ...
    "schemas/controlled-writer-adapter.schema.json",
    ...
    "docs/adapters/controlled-writer-interface.md",
