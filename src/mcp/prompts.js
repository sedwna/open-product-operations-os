...
export const PROMPTS = Object.freeze([
  {
    ...
    build: () => [
      ...
      "3. When the product side has an approved delivery contract and the owner has authorised crossing into engineering, drive the engineering half the same way: product_ops_next_engineering_work hands out one workstream with its write boundary, you delegate it to a subagent working in the application repository, and product_ops_submit_engineering_work takes the result back. Keep going until it reports every workstream complete. Independent verification comes last and changes nothing — a verifier that edits the repository has voided its own verification.",
